...
Java_com_tajuli_digitorandroid_editor_processing_NcnnVulkanNativeV52_createEngine(
    ...
    // PP-MattingV2 inference is dispatched to Vulkan. ncnn applies device/driver workarounds and
    // can retain CPU execution only where an individual converted layer has no Vulkan kernel.
