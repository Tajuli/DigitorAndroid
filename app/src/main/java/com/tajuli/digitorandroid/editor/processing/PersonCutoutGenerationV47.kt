...
// source-compatible. The V54 generation signature invalidates old ready markers and Analyze clears
// old files before writing the crash-safe CPU-base + GPU-temporal person-memory generation.
...
private const val V47_GENERATION_VERSION = "adaptive-v54-ppmattingv2-safe-base-gpu-memory-r1"
